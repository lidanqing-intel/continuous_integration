...
function test_cpu(){
    ...
    do
        ...
        $OUTPUT_BIN/${exe_bin} --model_name=${model_name} \
            ...
            --repeats=500 \
            --use_gpu=${use_gpu} | python3.7 ${CASE_ROOT}/py_mem.py "$OUTPUT_BIN/${exe_bin}" #>> ${log_file} 2>&1
    ...
    do
        ...
        do
            ...
            $OUTPUT_BIN/${exe_bin} --model_name=${model_name} \
                ...
                --use_mkldnn_=${use_mkldnn} | python3.7 ${CASE_ROOT}/py_mem.py "$OUTPUT_BIN/${exe_bin}" #>> ${log_file} 2>&1
