...
function test_mkldnn_int8(){
    ...
    do
        ...
        do
            echo " "
            printf "start ${YELLOW} ${model_name}, use_mkldnn: ${use_mkldnn}, use_mkldnn_int8: ${use_mkldnn_int8}, cpu_math_library_num_threads: ${cpu_math_library_num_threads}, batch_size: ${batch_size}${NC}\n"

            log_file="${LOG_ROOT}/${model_name}_mkldnn_int8_${cpu_math_library_num_threads}_bz${batch_size}_infer.log"
            cgdb --args $OUTPUT_BIN/${exe_bin} --model_name=${model_name} \
                ...
                --use_mkldnn_int8=${use_mkldnn_int8} # > ${log_file} 2>&1 | python3.7 ${CASE_ROOT}/py_mem.py "$OUTPUT_BIN/${exe_bin}" > ${log_file} 2>&1
...
function run_clas_mkl_int8_func(){
    ...
    do
        test_mkldnn_int8 "clas_benchmark" "${tests}" \
    ...
    #     test_mkldnn_int8 "clas_benchmark" "${model_case}" \
